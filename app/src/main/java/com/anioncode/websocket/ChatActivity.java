...
public class ChatActivity extends AppCompatActivity {
    ...
    private final class EchoWebSocketListener extends WebSocketListener {
        ...
        public void onOpen(WebSocket webSocket, Response response) {
            ...
            output("send : " + "Hello, it's SSaurel !");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model.getHeroes().observe(this, new Observer<List<String>>() {
            ...
            public void onChanged(List<String> strings) {
                ...
                System.out.println(adapter.getData().size()+"xxxxx");
                System.out.println(strings.size()+"xxxx");
...
//                model.SetItem(data);
                if(sizeData!=0){
                    MessagesRecycler.smoothScrollToPosition(sizeData - 1);
                }
